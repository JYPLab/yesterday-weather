...
const SCENARIOS: Record<string, { today: SessionWeather; yesterday: SessionWeather }> = {
  '서울': {
    yesterday: {
...
export function getMockWeather(region: string): WeatherComparison {
  const scenario = SCENARIOS[region] || SCENARIOS['서울'];
